...
const INITIAL_DATA = {
  ...
  opsTasks: [
    ...
    { id: "o2", freq: "opening", title: "Start music & set atmosphere", desc: "Queue up the playlist, set volume, check speaker zones", assignee: "", completions: {}, notes: "" },
    { id: "o3", freq: "opening", title: "Turn on all lighting", desc: "Main floor, bathrooms, lounge, retail display", assignee: "", completions: {}, notes: "" },
    { id: "o4", freq: "opening", title: "Front desk setup", desc: "Log into Beta, tablet ready, waivers live, POS on", assignee: "", completions: {}, notes: "" },
    { id: "o5", freq: "opening", title: "Bathroom opening check", desc: "Soap, paper, clean surfaces, no issues", assignee: "", completions: {}, notes: "" },
    { id: "o6", freq: "opening", title: "Retail display reset", desc: "Products faced, tags visible, display looks great", assignee: "", completions: {}, notes: "" },
    { id: "o7", freq: "opening", title: "Gym walkthrough & safety check", desc: "Mats positioned, holds tight, no hazards on the floor", assignee: "", completions: {}, notes: "" },
    { id: "o8", freq: "opening", title: "Chalk buckets stocked", desc: "All chalk stations filled and positioned", assignee: "", completions: {}, notes: "" },

    { id: "m1", freq: "midday", title: "Wipe down front desk", desc: "Clean surfaces, sanitize iPad, tidy retail area", assignee: "", completions: {}, notes: "" },
    ...
    { id: "m3", freq: "midday", title: "Bathroom midday check", desc: "Restock supplies, wipe surfaces, mop if needed", assignee: "", completions: {}, notes: "" },
    { id: "m4", freq: "midday", title: "Sweep high-traffic areas", desc: "Front desk, lounge, near the wall base", assignee: "", completions: {}, notes: "" },
    { id: "m5", freq: "midday", title: "Walk the gym — hospitality check", desc: "Say hi to guests, offer help, notice anything off", assignee: "", completions: {}, notes: "" },
    { id: "m6", freq: "midday", title: "Capture social content", desc: "One photo or video moment from the gym today", assignee: "", completions: {}, notes: "" },
    { id: "m7", freq: "midday", title: "Check water station", desc: "Refill, wipe down, restock cups if needed", assignee: "", completions: {}, notes: "" },
    ...
    { id: "c2", freq: "closing", title: "Remove all trash", desc: "Gym, bathrooms, lounge, back of house", assignee: "", completions: {}, notes: "" },
    { id: "c3", freq: "closing", title: "Sweep & mop floors", desc: "All non-mat areas — front desk, lounge, bathrooms", assignee: "", completions: {}, notes: "" },
    { id: "c4", freq: "closing", title: "Bathroom closing clean", desc: "Full clean, restock for tomorrow", assignee: "", completions: {}, notes: "" },
    { id: "c5", freq: "closing", title: "Organize rental shoes", desc: "Cleaned, paired, and ready for tomorrow", assignee: "", completions: {}, notes: "" },
    { id: "c6", freq: "closing", title: "Closing walkthrough", desc: "All lights off, doors locked, equipment secure", assignee: "", completions: {}, notes: "" },
    { id: "c7", freq: "closing", title: "Shut down all systems", desc: "POS, tablets, music, lights — everything off", assignee: "", completions: {}, notes: "" },
    { id: "c8", freq: "closing", title: "Log today's member count", desc: "Record total check-ins, day passes, new members in app", assignee: "", completions: {}, notes: "" },
